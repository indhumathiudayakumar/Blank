...
public class AccountTest {
	...
	public void whenAccountNumberIsInvalid() throws InvalidAccountNumberException
	{
		accountService.depositAmount(1000, 400);
	}*/
	
	/*@Test
	public void success() throws InvalidAccountNumberException
	{
		Account account =new Account();
		account.setAccountNumber(1012);
		account.setAmount(500);
		when(accountRepository.save(account)).thenReturn(true);
		assertEquals(account, accountService.depositAmount(1012, 500));
	}*/
